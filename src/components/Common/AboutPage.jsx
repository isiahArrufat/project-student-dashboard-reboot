  ...
  return (
    <div>
      ...
      <div>
        ...
        <img src="src/img/MichaelRestrepoross.jpg" alt="Michael Restrepoross's picture" /><br />
        ...
        <a href="https://github.com/MichaelARestrepoross">GitHub Link</a>
      </div>
      <div>
      <h2>Chris Miranda</h2>
        <img src="src/img/Christopher Miranda.jpg" alt="Chris Miranda's picture" /><br />
        <p> 
        Hello! My name is Christopher Miranda and I am a 27 year old from Yonkers, NY. I got into coding as it was always an interest of mine, but I never took any action on it. As a kid, I had been the <i>troubleshooter</i> in the house for anything computer/internet related. After not finishing college <small>(as I didn't know what I wanted to major in)</small> I worked dead end jobs for a couple of years. I was then introduced to <strong>Pursuit</strong> from a friend of mine and figured it was the best course of action to be where I want in the future.
        </p>
        <a href="https://github.com/ChrisCodeTrials">GitHub Link</a>
      </div>
      <div>
      <h2>Isiah Arrufat</h2>
        <img src="src/img/isiah_img.jpeg" alt="Isiah Arrufat's picture" /><br />
        <p>Description</p>
        <a href="https://github.com/isiahArrufat">GitHub Link</a>
      </div>
    </div>
  )
}
